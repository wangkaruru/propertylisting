                ...
                <div class="row">
                    <div class="col-md-9 mb30">
                        ...
                        @foreach ($listings as $listing)
                            ...
                            <img src="{{ asset("storage/images/$listing->image") }}" alt="">
...
<a href="{{url('contact')}}"><button  class="btn btn btn-primary btn-rounded  mb20">Click to Contact us</button></a>
                           ...
                           <p>50 by 100 prime plots for immediate development in kamakis. 1.8KM off ruiru bypass. Electricity, water and sewer line available. In a developed neighborhood and near a school. Ready titles.</p>
                            <hr>
